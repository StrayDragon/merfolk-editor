...
**新文件:** `src/canvas/selection/SelectionManager.ts`
...
**新文件:** `src/canvas/drag/DragManager.ts`
...
**组件:** `src/components/InlineEditor.svelte`
...
- 前置: FR-05 (撤销重做，用于命令历史)
- 被依赖: FR-08 (快捷键系统需要调用这些操作)
